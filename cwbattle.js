...
export function init(){
  ...
  // The stars
  jslix.addImage("image/cwt_battle/parts/StarTag.png")//Big
  jslix.addImage("image/cwt_battle/parts/StarTag2.png")//Over
  ...
  jslix.addFlipX()
  jslix.addImage("image/cwt_battle/units/idle/CWT_INFT_OS.png")
}
...
function horibattle(ctx){
  ...
  // Let's draw the unit
  ctx.drawImage(jslix.getImg(25), 0, 0, 16, 32, 100, 300, 64, 64)
