...
const createCwtGameInstance = () => {
  ...
  */
  ...
  exports.transfer = {
     ...
     */
    getMoneyTransferPackages: player =>
      [1000, 2500, 5000, 10000, 25000, 50000].filter(x => x <= player.gold),
  ...
  exports.supply = {
    ...
    supplySurroundingUnits(map, unit) {
      var t = model.unit_data[e];
      assert(t.type.supply), t.x, t.y;
      for (var o = t.owner, n = model.unit_firstUnitId(o), a = model.unit_lastUnitId(o); a > n; n++) model.unit_isValidUnitId(n) && 1 === model.unit_getDistance(e, n) && model.events.supply_refillResources(n)
    },
  ...
  exports.join = {
    ...
    combine(sourceUnit, targetUnit) {
      ...
      // TODO
      model.events.healUnit(te.target.unitId, model.unit_convertPointsToHealth(model.unit_convertHealthToPoints(o)), !0)

      exports.usable.setUnusable(targetUnit)
