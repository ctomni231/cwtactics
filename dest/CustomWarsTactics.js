...
stjs.extend(cwt.CapturableCmp, null, [], function(constructor, prototype) {
    prototype.points = 0;
}, {}, {});
stjs.ns("cwt");
cwt.JsUtil = function() {};
...
stjs.extend(cwt.FuelDrainerCmp, null, [], function(constructor, prototype) {
    prototype.drain = 0;
}, {}, {});
stjs.ns("cwt");
...
stjs.extend(cwt.SuicideCmp, null, [], function(constructor, prototype) {
    prototype.damage = 0;
    prototype.range = 0;
...
stjs.extend(cwt.SupplierCmp, null, [], function(constructor, prototype) {
...
stjs.extend(cwt.WeatherCmp, null, [], function(constructor, prototype) {
...
stjs.extend(cwt.HidableCmp, null, [], function(constructor, prototype) {
...
stjs.extend(cwt.BuyableCmp, null, [], function(constructor, prototype) {
    prototype.cost = 0;
}, {}, {});
stjs.ns("cwt");
cwt.TransportCmp = function() {};
stjs.extend(cwt.TransportCmp, null, [], function(constructor, prototype) {
    prototype.maxloads = 0;
    prototype.canload = null;
}, {canload: {name: "Array", arguments: [null]}}, {});
stjs.ns("cwt");
cwt.TileCmp = function() {};
stjs.extend(cwt.TileCmp, null, [], function(constructor, prototype) {
    prototype.defense = 0;
...
stjs.extend(cwt.RepairerCmp, null, [], function(constructor, prototype) {
...
stjs.extend(cwt.FactoryCmp, null, [cwt.IEntityComponent], function(constructor, prototype) {
...
stjs.ns("cwt");
cwt.MovableCmp = function() {};
stjs.extend(cwt.MovableCmp, null, [cwt.IEntityComponent], function(constructor, prototype) {
    prototype.fuel = 0;
    prototype.range = 0;
    prototype.type = null;
}, {type: "cwt.MoveType"}, {});
...
stjs.ns("cwt");
cwt.PlayerCmp = function() {};
stjs.extend(cwt.PlayerCmp, null, [cwt.IEntityComponent], function(constructor, prototype) {
    prototype.gold = 0;
...
stjs.extend(cwt.EntityManager, null, [cwt.ConstructedClass], function(constructor, prototype) {
    ...
    prototype.createEntityDataDump = function(dataCallback) {
        var data = ({});
        data["entityData"] = this.entities;
        data["counter"] = this.entityIdCounter;
        dataCallback(JSON.stringify(data));
    };
}, {entities: {name: "Map", arguments: [null, {name: "Map", arguments: [null, "cwt.IEntityComponent"]}]}}, {});
stjs.ns("cwt");
...
stjs.extend(cwt.Cwt, null, [cwt.ConstructedClass], function(constructor, prototype) {
    ...
    prototype.preload = function() {
        ...
        cwt.ConstructedFactory.getObject(cwt.SystemEvents).ERROR_RAISED.subscribe(stjs.bind(this, function(error) {
            this.error(error);
...
stjs.extend(cwt.TypeSys, null, [cwt.ISystem], function(constructor, prototype) {
    prototype.onInit = function() {
        cwt.ISystem.super.onInit();
    };
    prototype.createUnitType = function(data) {
        var id = data["ID"];
        this.entityManager().acquireEntityWithId(id);
    };
    prototype.parseTypeComponents = function(entityId, data, allowedComponents) {};
}, {}, {});
stjs.ns("cwt");
...
stjs.extend(cwt.PlayerSys, null, [cwt.ISystem], function(constructor, prototype) {
    prototype.onInit = function() {
        this.events().UNIT_DESTROYED.subscribe(stjs.bind(this, function(unit) {
            ...
            this.entityManager().getEntityComponent(ownC.owner, cwt.PlayerCmp).numOfUnits--;
        }));
...
stjs.extend(cwt.Move, null, [cwt.ISystem], function(constructor, prototype) {
    prototype.moveEntity = function(id, path) {
        ...
        var moveableC = this.entityManager().getEntityComponent(id, cwt.MovableCmp);
        var cX = posC.x;
        var cY = posC.y;
        var oX = cX;
        var oY = cY;
