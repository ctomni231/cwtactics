...
var startFlow = function() {
  ...
  cwtBuild.readFolder(gameSource, GAME_SOURCE_DIRECTORY + "/stateScope");
  ...
  cwtBuild.readFolder(cssSource, GAME_SOURCE_DIRECTORY + "/css");

  var htmlSource = new cwtBuild.StringBuilder();
  cwtBuild.readFile(htmlSource, GAME_SOURCE_DIRECTORY + "/html/start.html");
  cwtBuild.readFile(htmlSource, GAME_SOURCE_DIRECTORY + "/html/errorDialog.html");
  cwtBuild.readFile(htmlSource, GAME_SOURCE_DIRECTORY + "/html/updatePanel.html");
  cwtBuild.readFile(htmlSource, GAME_SOURCE_DIRECTORY + "/html/loadScreen.html");
  cwtBuild.readFile(htmlSource, GAME_SOURCE_DIRECTORY + "/html/mobileScreen.html");
  cwtBuild.readFile(htmlSource, GAME_SOURCE_DIRECTORY + "/html/mainScreen.html");
  cwtBuild.readFile(htmlSource, GAME_SOURCE_DIRECTORY + "/html/versusScreen.html");
  cwtBuild.readFile(htmlSource, GAME_SOURCE_DIRECTORY + "/html/playerSetup.html");
  cwtBuild.readFile(htmlSource, GAME_SOURCE_DIRECTORY + "/html/setMapping.html");
  cwtBuild.readFile(htmlSource, GAME_SOURCE_DIRECTORY + "/html/optionScreen.html");
  cwtBuild.readFile(htmlSource, GAME_SOURCE_DIRECTORY + "/html/gameScreen.html");
  ...
  cwtBuild.readFile(htmlSource, GAME_SOURCE_DIRECTORY + "/html/end.html");
