...
/**
 * URL of the active server where the game was downloaded from. This server will
 * be used to grab the game data.
 */
// TODO: rename to SERVER_PATH
exports.MOD_PATH = "http://localhost:8000/";

/**
 * URL of the active modification where the game will download the active game data.
 * This server will be used to grab the modification file.
 */
