cwt.Localization.registerLang({
  ...
  "NEXT": "Starte Spiel",
  "OPTIONS": "Optionen",
  "options.sfx": "Soundeffekte An/Aus",
  "options.music": "Musik An/Aus",
  "options.music.down": "Leiser",
  "options.music.up": "Lauter",
  "options.sfx.down": "Leiser",
  "options.sfx.up": "Lauter",
  "options.goBack": "Zurück",
  "options.addMap": "Karte hinzufügen",
  "options.resetData": "Spieldaten zurücksetzen",
  "options.setKeyboad": "Setze Keyboard-Mapping",
  "options.setGamepad": "Setze Gamepad-Mapping",
  "option.setKeys": "Setze Mapping",
