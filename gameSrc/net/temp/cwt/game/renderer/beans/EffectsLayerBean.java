...
public class EffectsLayerBean extends GraphicLayer {
  ...
  /*
   * Since the time is so low I probably don't need to track it. But it seems
   * memory intensive to pull off, there has to be a less expensive way
   */
  ...
  public void renderWeather() {
    ...
    for (int i = 0; i < type.$length(); i++) {
      ...
      ctx.drawImage(activeGraphic, posx.$get(i), posy.$get(i), 10 + 5 * type.$get(i),
          10 + 5 * type.$get(i));
    }
...
// if (constants.DEBUG) {
// console.log("Quick render of snow... needed " + ((new Date()).getTime() -
// time) + "ms");
// }
// }
// };
...
// //Finishes the testing of speed for snow particles
// if (constants.DEBUG) {
// console.log("Quick render of rain... needed " + ((new Date()).getTime() -
// time) + "ms");
// }
// }
// };
