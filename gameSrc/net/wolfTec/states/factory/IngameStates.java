...
public abstract class IngameStates {
     ...
     * state contains cursor handling, rendering logic and transfers the calls to the implemented state if necessary.
     *
     * @param state
     */
        ...
        ingameState.inputMove = new Callback2<Integer, Integer>() {
            ...
            public void $invoke(Integer x, Integer y) {
                if (state.inputMove != null) {
                    ...
                    CustomWarsTactics.gameWorkflowData.setCursorPosition(
                            CustomWarsTactics.renderCtx.convertToTilePos(x),
                            CustomWarsTactics.renderCtx.convertToTilePos(y),
                            true
                    );
                }
            }
