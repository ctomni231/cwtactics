...
public abstract class CustomWarsTactics {
	...
	/**
	 * Simple object that holds the status of the supported features of the
	 * current active web browser.
	 */
	...
	static {
		...
		inputHandler.backends.$put("keyboards", Keyboard.createBackend(inputHandler, ((Element) ((Object) Global.window.document))));
