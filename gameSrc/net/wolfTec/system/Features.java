...
/**
 * Holds the status of the supported features of the active browser environment
 * where CW:T runs in.
 */
@Namespace("cwt") public class Features {
	...
	/*
	 * static { audioSFX = ((Browser.chrome || Browser.safari || (Browser.ios &&
	 * Browser.version >= 6)) == true); audioMusic = ((Browser.chrome ||
	 * Browser.safari) == true); gamePad = ((Browser.chrome &&
	 * !!navigator.webkitGetGamepads) == true); keyboard = (Browser.mobile !=
	 * true); mouse = (Browser.mobile != true); touch = (Browser.mobile == true);
	 * supported = ((Browser.chrome || Browser.safari || Browser.ios ||
	 * Browser.android) == true); iosWebSQLFix = ((Browser.ios && Browser.version
	 * == 7) == true); }
	 */
}
