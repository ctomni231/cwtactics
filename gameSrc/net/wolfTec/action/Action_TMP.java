 ...
 */
public class Action_TMP {

	public static enum SourceToTarget {
		SOURCE_AND_TARGET, SOURCE_AND_SUBTARGET
	}

	public static enum ActionType {
		PROPERTY_ACTION, CLIENT_ACTION, ENGINE_ACTION, UNIT_ACTION, MAP_ACTION
	}
	...
	public static enum TargetSelectionType {
		BEFORE_SUB_ACTION, AFTER_SUB_ACTION
	}
	...
	public Action_TMP.MovingAction	                      positionUpdateMode;

	/**
	 * Type of the action.
	 */
	public Action_TMP.ActionType	                        type;
	...
	/**
	 * Marks the target selection mode. Mode 'BEFORE_SUB_ACTION' will be done
	 * before the sub menu. Mode 'AFTER_SUB_ACTION' will be done after the sub
	 * menu.
	 */
