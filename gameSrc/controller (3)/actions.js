...
cwt.Action = my.Class({
  ...
  STATIC: {
    ...
    /**
     * Engine actions (4) are callable by the engine itself.
     */
    ENGINE_ACTION: 3,
    ...
    buildFromData: function (scope) {
      ...
      // all unit actions (4) invokes automatically waiting
  ...
  /**
   * Multistep actions (4) has a lifecycle that survives one command evaluation
   * step.
   */
