...
controller.stateMachine.data = {
  ...
  // `controller (3).TaggedPosition`. An instance of `model (2b).player_RELATION_MODES` will be returned.
  //
  ...
  // type `controller (3).TaggedPosition`. An instance of `model (2b).player_RELATION_MODES` will be
  // returned.
  //
