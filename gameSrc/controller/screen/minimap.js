...
cwt.Minimap = {
   ...
   */
  mapSelectionCanvas: document.getElementById("cwt_versus_minimap_canvas"),
   ...
   * @type {HTMLElement}
   */
  ingameCanvas: document.getElementById("cwt_ingame_minimap_canvas"),
   ...
   * @type {HTMLElement}
   */
  ingameBlend: document.getElementById("cwt_ingame_minimap_blend"),

  /**
   * Shows the mini map container in the game round screen.
   */
  showIngameMinimap: function () {
   ...
   * Draws the minimap.
   */
  renderMinimap_: function (canvas, w, h, map, typeMap, biggerMap) {
  ...
  /**
   * Draws the map selection mini map. The aw2 will be extracted
   * from the given mapData which is a loaded map file aw2 model.
   *
   * @param mapData
   */
  renderMapSelectionMinimap: function (mapData) {
