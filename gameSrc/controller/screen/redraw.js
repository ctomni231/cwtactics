/**
 * Redraw object that saves all positions, that needs to be
 * redrawn in the next available graphic frame.
 *
 * @namespace
 */
cwt.RedrawCache = {
   ...
   *
   * TODO (in future the value will be true|false)
   */
  changes_: 0,
   ...
   *
   */
  data_: util.matrix(MAX_MAP_WIDTH, MAX_MAP_HEIGHT, false),

  /**
   *
   */
  REDRAW_MODE_RECTANGLE:0,

  /**
   *
   */
  REDRAW_MODE_CIRCLE:1,
   ...
   * @param redrawMode
   */
  markPos: function (x, y, sizeX, sizeY, redrawMode) {
  ...
  //    x
  //
  markPosWithNeighbours: function (x, y) {
  ...
  //  x x x
  //
  markPosWithNeighboursRing: function (x, y) {
