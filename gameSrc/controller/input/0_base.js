cwt.Input = my.Class({
  ...
  STATIC: {
    ...
    /**
     * Controls the availability to push input keys into the
     * command system.
     *
     * @private
     */
    ...
    /**
     * Request generic inputs from extended / re-mappable input devices
     * like keyboards or game pads.
     *
     * @private
     */
    generic_: false,
