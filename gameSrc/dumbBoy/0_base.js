...
//
//  - DB should define long term tasks for himself to organize his actions (4)
...
controller.ai_machine = util.stateMachine({
  ...
  // wrong. At least no logic (2a) will be done
  ...
  // ++++++++++++++++++++++++++++++++++++++++
  // Start turn actions (4). At the moment
    ...
    while( true ){
      ...
      if( loopData.i < loopData.e ){
        if( loopData.i < loopData.prop ){
          ...
          //util.log(controller (3).ai_spec,"- ..for unit",loopData.i);
          ...
          //util.log(controller (3).ai_spec,"- ..for property",loopData.i);
        ...
        //util.log(controller (3).ai_spec,"- ..for map");
        dataTp = 2;
      }
