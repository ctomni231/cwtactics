...
import org.wolftec.cwt.audio.Audio;
...
public class OptionsMenuState extends AbstractMenuState
{
  ...
  public void onConstruction()
  {
    ...
    ui.registerMulti(UIC_DECREASE_SFX, JSCollections.$array(GameActions.BUTTON_LEFT, GameActions.BUTTON_RIGHT),
                     UIC_INCREASE_SFX);
    ...
    ui.registerMulti(UIC_INCREASE_SFX, JSCollections.$array(GameActions.BUTTON_LEFT, GameActions.BUTTON_RIGHT),
                     UIC_DECREASE_SFX);
    ...
    ui.registerMulti(UIC_DECREASE_MUSIC, JSCollections.$array(GameActions.BUTTON_LEFT, GameActions.BUTTON_RIGHT),
                     UIC_INCREASE_MUSIC);
    ...
    ui.registerMulti(UIC_INCREASE_MUSIC, JSCollections.$array(GameActions.BUTTON_LEFT, GameActions.BUTTON_RIGHT),
                     UIC_DECREASE_MUSIC);
