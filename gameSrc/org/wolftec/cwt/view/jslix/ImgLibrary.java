package org.wolftec.cwt.view.jslix;
 ...
 * ImgLibrary.java
 * 
 * This is the one that will be used to render the images on the screen. Hoping
 * for a very simple and easy to use version that will just have the bare bones
 * operations.
 *
 */
public class ImgLibrary
{
  ...
  // Just getting started on transferring of jstest into here. Most likely,
  // it'll be the first four
  // functions to start followed by some recoloring logic in the future. The
  // class will try to keep
  // a very simplistic view on image storage, but also try to do really quick
