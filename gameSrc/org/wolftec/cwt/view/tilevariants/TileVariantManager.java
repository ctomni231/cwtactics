package org.wolftec.cwt.view.tilevariants;
...
public class TileVariantManager {
   ...
   *
   * @param {string}
   *          type ID of the tile where the variant information will be used
   * @param {object}
   *          desc
   * @param {object}
   *          connection
   ...
   */
  public void updateTileSprites(TileMap model) {
    int x;
    int y;
