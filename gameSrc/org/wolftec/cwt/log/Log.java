...
public class Log implements Constructable
{
  ...
  public void info(String msg)
  {
    if (!disabled)
    {
      Global.console.log("%c[" + now() + "][" + loggerName + "][ INFO] %c" + msg, Constants.LOGGER_CSS_INFO_HEAD,
                         Constants.LOGGER_CSS_TEXT);
    }
  }
  ...
  public void warn(String msg)
  {
    if (!disabled)
    {
      Global.console.log("%c[" + now() + "][" + loggerName + "][ WARN] %c" + msg, Constants.LOGGER_CSS_WARN_HEAD,
                         Constants.LOGGER_CSS_TEXT);
    }
  }
  ...
  public void error(String msg, @OptionalParameter Exception e)
  {
    if (!disabled)
    {
      Global.console.log("%c[" + now() + "][" + loggerName + "][ERROR] %c" + msg, Constants.LOGGER_CSS_ERROR_HEAD,
                         Constants.LOGGER_CSS_TEXT);
