...
public class IngameMovepathSelectionState extends GameroundState implements Configurable {
  ...
  private TagValue fastClickMode;

  @Override
  public void onConstruction() {
    fastClickMode = new TagValue("app.input.fastClick", 0, 1, 0);
  }
