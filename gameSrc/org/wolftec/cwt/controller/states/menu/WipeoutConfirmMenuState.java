...
public class WipeoutConfirmMenuState extends MenuState {
  ...
  public void onConstruction() {
    ui.registerMulti(UIC_YES, JSCollections.$array(GameActionConstants.BUTTON_LEFT, GameActionConstants.BUTTON_RIGHT), UIC_NO);
    ui.registerMulti(UIC_NO, JSCollections.$array(GameActionConstants.BUTTON_LEFT, GameActionConstants.BUTTON_RIGHT), UIC_YES);
  }
