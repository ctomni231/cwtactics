...
public class Tests {
  ...
  public Tests() {
    tests = JSCollections.$array();
    ReflectionUtil.forEachClassOfType(Test.class, (t) -> tests.push(ReflectionUtil.createInstance(t)));
    tests.sort((a, b) -> StringUtil.compare(ClassUtil.getClassName(a), ClassUtil.getClassName(b)));
  }
