...
import org.wolftec.cwt.system.annotations.Async;
import org.wolftec.cwt.system.annotations.AsyncCallback;
...
public abstract class ListUtil {
   ...
   */
  @Async
  public static <T> void forEachArrayValueAsync(Array<T> array, @AsyncCallback Callback3<Integer, T, Callback0> callback, @AsyncCallback Callback0 doneCb) {
    if (callback == null) {
