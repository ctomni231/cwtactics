...
public class StateDt implements Injectable {
  //
  ...
  // p3 = exports.target.x;
  // p4 = exports.target.y;
  // p5 = move.codeFromAtoB(p3, p4, exports.targetselection.x,
  // exports.targetselection.y);
  // break;
  //
  // case "loadUnit":
  ...
  //
  // case "supplyUnit":
  // conditionResult = action.condition(exports.source.unit, exports.target.x,
  // exports.target.y);
  // break;
  //
  // case "buildUnit":
  ...
  //
  // case "loadUnit":
  // conditionResult = action.condition(exports.target.unit,
  // exports.source.unit);
  // break;
  //
  // case "transferUnit":
  ...
  //
  // case "transferMoney":
  // conditionResult = action.condition(model.turnOwner, exports.target.x,
  // exports.target.y);
  // break;
  //
  // case "unitUnhide":
  ...
  //
  // case "attack":
  // action.prepareTargets(exports.source.unit, exports.target.x,
  // exports.target.y, exports.selection);
  // break;
  // }
  // };
  //
  ...
  //
  // case "unloadUnit":
  // action.prepareMenu(exports.source.unit, exports.target.x, exports.target.y,
  // exports.menu);
  // break;
  //
  // case "transferUnit":
  ...
  //
  // //
  // // Moves the cursor to a given position. The view will be moved as well
  // with
