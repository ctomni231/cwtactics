...
import org.wolftec.cwt.logic.MoveLogic.AStar;
import org.wolftec.cwt.logic.MoveLogic.Graph;
import org.wolftec.cwt.logic.MoveLogic.Node;
import org.wolftec.cwt.logic.MoveLogic.Window;
...
public class Movable extends Specialization<Unit> {
  ...
  public boolean trapCheck(Battlefield model, RingList<Integer> movePath, PositionData source, PositionData target) {
    NullUtil.getOrThrow(source.unit);
   ...
   *         position, else false
   */
  public boolean canMoveSomewhere(GameroundEnder model, PositionData position) {
