...
public class Fighter extends Specialization<Unit> {
  ...
  private TagValue cfgDaysOfPeace;
  private TagValue cfgDamageCalculation;

  @Override
  public void onConstruction() {
    cfgDaysOfPeace = new TagValue("game.daysOfPeace", 0, 50, 0);
    cfgDamageCalculation = new TagValue("game.damageCalc.mode", 0, 1, 0);
  }
