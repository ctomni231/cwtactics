...
public class Supplier<T extends Ownable> extends Specialization<T> {
  ...
  public void propertyRepairsAt(int x, int y) {
    ...
    int diff = unit.heal(prop.type.repairAmount);
    unit.owner.earnMoney(unit.type.getCostsByPercentage(diff));
  }
}
