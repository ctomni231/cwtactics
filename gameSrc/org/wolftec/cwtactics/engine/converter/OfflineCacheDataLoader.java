...
public class OfflineCacheDataLoader implements ConstructedClass {
  ...
  // config.driver = JSCollections.$array(LocalForage.localforage.INDEXEDDB,
  // LocalForage.localforage.WEBSQL);
  // config.name = Constants.OFFLINE_DB_NAME;
  // config.size = Constants.OFFLINE_DB_SIZE;
  // LocalForage.localforage.config(config);
  // }
  //
  // public void loadFolderData(Playground game, String folder, Class<? extends
  ...
  // if (value == null) {
  // ConstructedFactory.getObject(BrowserService.class).doXmlHttpRequest(data.url,
  // null, (objData, error) -> {
  // loadRemoteFolderByContentList(game, folder, (Array<String>)
  // JSGlobal.JSON.parse((String) objData), dataClass);
  // });
  // } else {
  // loadCachedFolderByContentList(game, folder, (Array<String>) value,
  // dataClass); // TODO
  // // typecheck
  // }
  // });
  ...
  // }
  //
  // private <T extends ObjectType> void
  // loadRemoteFolderByContentList(Playground game, String folder, Array<String>
  // content, Class<T> dataClass) {
  ...
  // type.grabDataFromMapGlobal((Map<String, Object>)
  // JSGlobal.JSON.parse((String) objData));
  ...
  //
  // private <T extends ObjectType> void
  // loadCachedFolderByContentList(Playground game, String folder, Array<String>
  // content, Class<T> dataClass) {
  // JsUtil.forEachArrayValue(content, (index, id) -> {
  // AssetEntry data = game.getAssetEntry(id, folder, "json");
  //
