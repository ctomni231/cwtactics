...
import org.wolfTec.wolfTecEngine.Globals;
...
public class ConnectedTile {
  ...
  public ConnectedTile(Map<String, String> desc, Array<Array<String>> connection) {
    this.desc = desc;
   ...
   *
   */
  public int getVariant(String typeN, String typeE, String typeS, String typeW, String typeNE,
      String typeSE, String typeSW, String typeNW) {
