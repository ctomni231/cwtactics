...
public class TouchInputBean implements InputBackend {
  ...
  private Callback1<Object> touchStartHandler = (event) -> {
  ...
  private Callback1<Object> touchMoveHandler = (event) -> {
    $js("event.preventDefault()");
  ...
  private Callback1<Object> touchEndHandler = (event) -> {
    $js("event.preventDefault()");
  ...
  public void enable() {
    ...
    $js("document.addEventListener(EVENT_TOUCH_START, this.touchStartHandler, false)");
    $js("document.addEventListener(EVENT_TOUCH_MOVE, this.touchMoveHandler, false)");
    $js("document.addEventListener(EVENT_TOUCH_END, this.touchEndHandler, false)");
  }

  @Override
  public void disable() {
    log.info("enable touch input");
    $js("document.removeEventListener(EVENT_TOUCH_START, this.touchStartHandler, false)");
    $js("document.removeEventListener(EVENT_TOUCH_MOVE, this.touchMoveHandler, false)");
    $js("document.removeEventListener(EVENT_TOUCH_END, this.touchEndHandler, false)");
  }
