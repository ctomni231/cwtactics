...
@Bean
public class InputMappingManagerBean {
  ...
  public void saveConfig(Callback0 callback) {
    ...
    storage.set(EngineGlobals.STORAGE_PARAMETER_INPUT_MAPPING, mappings, (data, error) -> {
      if (error != null) {
  ...
  public void loadConfig(Callback0 callback) {
    storage.get(EngineGlobals.STORAGE_PARAMETER_INPUT_MAPPING, (entry) -> {
