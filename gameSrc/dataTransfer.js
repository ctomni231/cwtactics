 ...
 * @param callback
 */
exports.transferImageToStorage = function (type, sprite, callback) {
    if (!sprite instanceof image.Sprite) debug.logCritical("IllegalArgumentType");
 ...
 * @param callback
 */
exports.transferImageFromStorage = function (type, path, imgType, callback) {
 ...
 * @param callback
 */
exports.transferAllImagesToStorage = function (callback) {
 ...
 * @param callback
 */
exports.transferAllImagesFromRemote = function (callback) {
...
//
exports.transferAllImagesFromStorage = function (callback) {
    var graphics = require("../dataTransfer/mod").getMod().graphics;
 ...
 * @param callback
 */
exports.transferAudioFromStorage = function (callback) {
        ...
        stuff.push(function (next) {
            storage.get(key, function (value) {
                ...
                audio.decodeAudio(
                    ...
                    // error handling
                    function () {
                        require("../error").raiseError("could not loadGameConfig audio from cache","audioDTO");
                    }
                );
            });
        });
 ...
 * @param callback
 */
exports.transferAudioFromRemote = function (callback) {
    ...
    var loadBuffer = function (id, audioData, callback) {
        audio.decodeAudio(
            ...
            // error handling
            function (e) {
                require("../error").raiseError("could not loadGameConfig audio from remote","audioDTO");
            }
        );
    };
...
exports.loadVolumeConfigs = function (callback) {
    ...
    storage.get(SFX_VOLUME_KEY, function (value) {
        if (value) audio.setSfxVolume(value);

        // music config
        storage.get(MUSIC_VOLUME_KEY, function (value) {
            if (value) audio.setMusicVolume(value);
...
exports.transferAllMapsFromStorage = function(callback) {
    storage.get(KEY_MAPS,function(value) {
        exports.maps = value;
        callback();
    });
};
...
//
//
exports.transferAllMapsFromRemote = function(callback) {
 ...
 * @param callback
 */
exports.transferMapFromStorage = function(path, callback) {
