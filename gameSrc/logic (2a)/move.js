...
cwt.Move = {
  ...
  /**
   * Little helper array object for `model (2b).move_fillMoveMap`. This will be used
   * only by one process. If the helper is not available then a temp object will
   * be created in `model (2b).move_fillMoveMap`. If the engine is used without client
   * hacking then this situation never happen and the `model (2b).move_fillMoveMap`
