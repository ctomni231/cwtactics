...
var testMap = {
  ...
  players:[
    ...
    { name:"Player 1", gold:1000 , team:1,
      units:[
        { x:2, y:2, type:"TANK"    , ammo:5, hp:100, owner:0, fuel:50 },
        { x:2, y:5, type:"APCR"      , ammo:5, hp:100, owner:0, fuel:25 },
        { x:2, y:7, type:"INFT_OS" , ammo:0, hp:100, owner:0, fuel:50 },
    ...
    { name:"Player 2", gold:0    , team:2,
      units:[
        ...
        { x:3, y:14, type:"INFT_OS" , ammo:0, hp:29, owner:1, fuel:50 },
        { x:12, y:7, type:"TANK"    , ammo:5, hp:100, owner:1, fuel:50 },
        { x:11, y:9, type:"TANK"    , ammo:5, hp:100, owner:1, fuel:50 },
        { x:7, y:6, type:"TANK"     , ammo:5, hp:100, owner:1, fuel:50 }
      ]
    },
