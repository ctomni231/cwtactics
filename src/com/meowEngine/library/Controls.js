(function(){
     ...
     */
	meowEngine.input.keyDown = function( keyID ){
		_downKeys[keyID] = _on;
	};
     ...
     * @param {Number} keyID key identical number
     */
	meowEngine.input.keyUp = function( keyID ){
     ...
     */
	meowEngine.input.bindKey = function( keyID, action ){
     ...
     * @param {String} action action name
     */
	meowEngine.input.unbindKey = function( keyID, action ){
     ...
     */
    meowEngine.input.key = function( keyID ){
     ...
     */
	meowEngine.input.action = function( action ){
    ...
    meowEngine.signals.onSignal( meowEngine.MEOW_SHORTCUTS , function(){
       ...
       $inputAction = meowEngine.input.action;
    });
