...
public class ImgLibrary extends Component{
     ...
     * color in the next loaded image using the Slick2D color object.
    ...
    /**
     * Makes a slick2D color box with the specified size. This is used to keep
     * images from ever becoming null.
     *
     * @param newColor The color of the box
     * @param boxName The name of this color box
    ...
    public org.newdawn.slick.Image getColorBox(Color newColor,
        ...
        return il.makeSlickImage(getColorBox(getColor(newColor),
                sizex, sizey), boxName);
    }
    ...
    /**
     * This function returns an Slick2D image stored within an ImgLibrary
     * using an String reference. It stores the image after loading it
     * for quicker calls.
     *
     * @param ref The image reference or filename of the image
     * @return An image from the index if true; a red dot if false
    ...
    /**
     * This function returns a slick2D image stored within an ImgLibrary
     * using an array index. It stores the image after loading it for
     * quicker calls.
     *
     * @param index The index where this image is located
     * @return An image from the index if true; a red dot if false
    ...
    public org.newdawn.slick.Image getSlickImage(int index){
        ...
        if(index >= 0 && index < sortedImg.length && temp == null){
            temp = il.makeSlickImage(getImage(index),
        ...
        return (temp != null) ? temp : il.makeSlickImage(getColorBox(
    ...
    /**
     * This function changes a Slick color into a Java color
     * @param color The current Slick2D color
     * @return The color in Java2D
     */
    ...
    /**
     * This function changes a java2D color into a slick2D color
     * @param color The current Slick2D color
     * @return The color in Slick
     */
    ...
    /**
     * This function adds translucency to a slick2D color
     * @param color The current slick2D color
     * @param alpha The amount of opacity to apply (0-255)
     * @return The slick2D color with the appended opacity
     */
