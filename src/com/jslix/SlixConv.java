...
public class SlixConv {
    ...
    public static String conv = "/Helps convert Slick keys to java keys\n"+
        "/JAVA=http://java.sun.com/javase/6/docs/api/constant-values.net.wolfTec.html\n"+
        "/SLICK=http://slick.cokeandcode.com/javadoc/\n"+
        "Created by: JakeSamiRulz\n"+
        "\n"+
        "/Key Command\n"+
        "/[Slick #][Java #][Key Reference]\n"+
        "/Mouse Command\n"+
        "/[>][Slick #][Java #][Mouse Reference]\n"+
        "\n"+
        "/Mouse Row\n"+
        "> 0 1 LEFT\n"+
        "> 1 3 RIGHT\n"+
        ...
        "184 18 RIGHT_ALT\n"+
        "221 525 LIST\n"+
        "157 17 RIGHT_CONTROL\n"+
        "\n"+
        "/Print Screen Row\n"+
        "183 154 PRINT_SCREEN\n"+
        "70 145 SCROLL_LOCK\n"+
        "197 19 PAUSE\n"+
        "210 155 INSERT\n"+
        "199 36 HOME\n"+
