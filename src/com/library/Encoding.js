(function(){
	 ...
	 * @function
	 */
	meowEngine.encoder.encode = function( str, algorithm ){
	 ...
	 *		  argument
	 */
	meowEngine.encoder.pushEncoder = function( name, registerFunc ){
	 ...
	 * @function
	 */
	meowEngine.encoder.hasEncoder = function( name ){
	 ...
	 *
	 *  @param {String} string string that will be encoded
	 *  @return {String} encoded string
	 */
    ...
    /** @constant */ 
    meowEngine.encoder.MD5 = "MD5";

    /** @constant */ 
    meowEngine.encoder.SHA256 = "SHA256";

    /** @constant */ 
    meowEngine.encoder.CRC32 = "CRC32";

    /** @constant */
    meowEngine.encoder.BASE64 = "BASE64";
    ...
    meowEngine.signals.onSignal( meowEngine.MEOW_SHORTCUTS , function(){
       $encode = meowEngine.encoder.encode;
    });
